...
1) connect to the access point (if your phone warns you about no internet connection and no key go ahead)
2) type http://192.168.4.1 on your browser
3) put new text on the box and click "update display".
connections:
